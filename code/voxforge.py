...
if __name__ == '__main__':
    ...
    create_manifest('voxforge_sample_files/train/', 'voxforge_train_manifest.csv', args.min_duration, args.max_duration)
    create_manifest('voxforge_sample_files/test/', 'voxforge_test_manifest.csv',args.min_duration, args.max_duration)
