...
class DefaultArguments():
    ...
    def __init__(self):
        ...
        self.train_manifest = 'data/voxforge_train_manifest.csv'
        ...
        self.model_path = 'models/iteration2.pth' # 'Location to save best validation model'
        ...
        self.no_shuffle = False # 'Turn off shuffling and sample from dataset based on sequence length (smallest to largest)'
        ...
        self.loss_scale = 1 # Loss scaling used by Apex. Default is 1 due to warp-ctc not supporting scaling of gradients'
